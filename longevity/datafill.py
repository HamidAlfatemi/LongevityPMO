...
Node.objects.filter(ref_num='813').update(width=267, height=855, posx=2502, posy=117)
Node.objects.filter(ref_num='814').update(width=934, height=5556, posx=10, posy=3462)
